...
public class BattleSystem : MonoBehaviour
{
    ...
    IEnumerator SetUpBattle()
    {
        ...
        turnInfoText.text = "The Battle Begins!";
    ...
    IEnumerator PerformTurn(Unit attacker, Unit defender, BattleState nextState)
    {
        ...
        turnInfoText.text = attacker.unitName + " attacks!";
        ...
        if (defender.currentHealthPoints <= 0)
        {
            ...
            turnInfoText.text = attacker.unitName + " killed " + defender.unitName + "!";
            statusInfoText.text = "Gloty to the Winner!";
    ...
    IEnumerator ShowMessages()
    {
        ...
        {
            statusInfoText.text = _messages.Dequeue();
            yield return new WaitForSeconds(2f);
        }
